...
namespace Tests
{
    ...
    {
        private string _text = "ابجد هوز حطي كلمن سعفص قرشت ثخذ ضظغ";
        ...
        public void Encode_JesusCipher()
        {
            ...
            Assert.AreEqual("ي١-ي٢-ي٥-س١ / ع٥-ع٦-س٤ / ي٦-و٢-ع٧ / ع١-ع٢-ع٣-ع٤ / س٥-و٤-و٦-س٧ / و٧-س٣-س٦-ي٣ / ي٤-ي٧-س٢ / و١-و٣-و٥", result);
        }
        ...
        public void Encode_NumericCipher()
        {
            ...
            Assert.AreEqual("١-٢-٥-٨ / ٢٦-٢٧-١١ / ٦-١٦-٢٨ / ٢٢-٢٣-٢٤-٢٥ / ١٢-١٨-٢٠-١٤ / ٢١-١٠-١٣-٣ / ٤-٧-٩ / ١٥-١٧-١٩", result);
        }
        ...
        public void Encode_BinaryCipher()
        {
            ...
            Assert.AreEqual("00001-00010-00101-01000 / 11010-11011-01011 / 00110-10000-11100 / 10110-10111-11000-11001 / 01100-10010-10100-01110 / 10101-01010-01101-00011 / 00100-00111-01001 / 01111-10001-10011", result);
        }
        ...
        public void Encode_ClockCWCipher()
        {
            ...
            Assert.AreEqual("١:١٢-١:١-١:٤-١:٧ / ٣:١-٣:٢-١:١٠ / ١:٥-٢:٣-٣:٣ / ٢:٩-٢:١٠-٢:١١-٣:١٢ / ١:١١-٢:٥-٢:٧-٢:١ / ٢:٨-١:٩-٢:١٢-١:٢ / ١:٣-١:٦-١:٨ / ٢:٢-٢:٤-٢:٦", result);
        }
        ...
        public void Encode_ClockCCWCipher()
        {
            ...
            Assert.AreEqual("١:١٢-١:١١-١:٨-١:٥ / ٣:١١-٣:١٠-١:٢ / ١:٧-٢:٩-٣:٩ / ٢:٣-٢:٢-٢:١-٣:١٢ / ١:١-٢:٧-٢:٥-٢:١١ / ٢:٤-١:٣-٢:١٢-١:١٠ / ١:٩-١:٦-١:٤ / ٢:١٠-٢:٨-٢:٦", result);
        }
        ...
        public void Encode_Mobile1stCipher()
        {
            ...
            Assert.AreEqual("٣-٢-٦-٥ / ٧٧-٧٧٧-٥٥٥٥ / ٦٦-٩-٧٧٧٧ / ٨٨٨-٨٨٨٨-٨٨٨٨٨-٧ / ٤-٩٩٩-٨-٤٤٤ / ٨٨-٥٥٥-٤٤-٢٢ / ٢٢٢-٦٦٦-٥٥ / ٤٤٤٤-٩٩-٩٩٩٩", result);
        }
        ...
        public void Encode_Mobile2ndCipher()
        {
            ...
            Assert.AreEqual("٣^١-٢^١-٦^١-٥^١ / ٧^٢-٧^٣-٥^٤ / ٦^٢-٩^١-٧^٤ / ٨^٣-٨^٤-٨^٥-٧^١ / ٤^١-٩^٣-٨^١-٤^٣ / ٨^٢-٥^٣-٤^٢-٢^٢ / ٢^٣-٦^٣-٥^٢ / ٤^٤-٩^٢-٩^٤", result);
        }
        ...
        public void Encode_XCipher()
        {
            ...
            Assert.AreEqual("V(١)-V(٢)-V(٥)->(١) / <(٥)-<(٦)->(٤) / V(٦)-Λ(٢)-<(٧) / <(١)-<(٢)-<(٣)-<(٤) / >(٥)-Λ(٤)-Λ(٦)->(٧) / Λ(٧)->(٣)->(٦)-V(٣) / V(٤)-V(٧)->(٢) / Λ(١)-Λ(٣)-Λ(٥)", result);
        }
        ...
        public void Encode_StarCipher()
        {
            ...
            Assert.AreEqual("▲١-▲٢-▲٥-▶١ / ▼٥-▼٦-▶٤ / ▲٦-◀٢-▼٧ / ▼١-▼٢-▼٣-▼٤ / ▶٥-◀٤-◀٦-▶٧ / ◀٧-▶٣-▶٦-▲٣ / ▲٤-▲٧-▶٢ / ◀١-◀٣-◀٥", result);
        }
        ...
        public void Encode_RhombusCipher()
        {
            ...
            Assert.AreEqual("١◣-١◢-٢◣-٢◥ / ٧◢-٧◤-٣◤ / ٢◢-٤◥-٧◥ / ٦◢-٦◤-٦◥-٧◣ / ٣◥-٥◢-٥◥-٤◢ / ٦◣-٣◢-٤◣-١◤ / ١◥-٢◤-٣◣ / ٤◤-٥◣-٥◤", result);
        }
        ...
        public void Encode_TriangleCipher()
        {
            ...
            Assert.AreEqual("١▲-٢◣◼-٣◼(١)-٤◼(١) / ٧◼(٤)-٧◼(٥)-٥◣◼ / ٣◼◢-٦◣◼-٧◼◢ / ٧◣◼-٧◼(١)-٧◼(٢)-٧◼(٣) / ٥◼(١)-٦◼(٢)-٦◼(٤)-٥◼(٣) / ٦◼◢-٤◼◢-٥◼(٢)-٢◼◢ / ٣◣◼-٤◣◼-٤◼(٢) / ٥◼◢-٦◼(١)-٦◼(٣)", result);
        }
